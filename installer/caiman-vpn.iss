...
#define MyAppName "Caiman VPN"
#define MyAppPublisher "Caiman VPN"
#define MyAppURL "https://github.com/Cayman152/Caiman-VPN-Client"
#define MyAppExeName "CaimanVPN.exe"
...
DefaultDirName={autopf}\Caiman VPN
DefaultGroupName={#MyAppName}
DisableProgramGroupPage=yes
ArchitecturesAllowed=x64compatible
ArchitecturesInstallIn64BitMode=x64compatible
OutputDir={#OutputDir}
OutputBaseFilename=CaimanVPN-Setup-x64
