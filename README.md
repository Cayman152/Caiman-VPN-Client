...
- Workflow: `Caiman VPN Windows Build`
- Артефакт после успешной сборки: `CaimanVPN-Setup-x64.exe`

## Сборка macOS

- Workflow: `Caiman VPN macOS Build`
- Артефакты после успешной сборки:
  - `CaimanVPN-macOS-arm64.pkg`
  - `CaimanVPN-macOS-x64.pkg`
