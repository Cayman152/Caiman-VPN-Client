...
public class Global
{
    ...
    public const string AppName = "Caiman VPN";
    ...
    public const string AutoRunName = "CaimanVPNAutoRun";
    ...
    public const string AvaAssets = "avares://CaimanVPN/Assets/";
    public const string LocalAppData = "CAIMANVPN_LOCAL_APPLICATION_DATA_V2";
    ...
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/CaimanVPN/template.json",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/CaimanVPN/template.json"
    ];

    public static readonly List<string> DNSTemplateSources =
    [
        "",
        @"https://raw.githubusercontent.com/runetfreedom/russia-v2ray-custom-routing-list/main/CaimanVPN/",
        @"https://raw.githubusercontent.com/Chocolate4U/Iran-v2ray-rules/main/CaimanVPN/"
    ];
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.CaimanVPN, "Cayman152/vpn-client" },
    };
