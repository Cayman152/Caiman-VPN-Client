...
public class Utils
{
    ...
    public static string StartupPath()
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "CaimanVPN");
        }
    ...
    public static bool IsPackagedInstall()
    {
        try
        {
            ...
            if (p.StartsWith("/opt/CaimanVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/lib/CaimanVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/share/CaimanVPN", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }
        }
