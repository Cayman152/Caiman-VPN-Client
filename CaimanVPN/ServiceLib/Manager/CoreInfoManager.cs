...
public sealed class CoreInfoManager
{
    ...
    {
        var urlN = GetCoreUrl(ECoreType.CaimanVPN);
        ...
        [
            new CoreInfo
                {
                    CoreType = ECoreType.CaimanVPN,
                    Url = GetCoreUrl(ECoreType.CaimanVPN),
                    ReleaseApiUrl = urlN.Replace(Global.GithubUrl, Global.GithubApiUrl),
                    DownloadUrlWin64 = urlN + "/download/{0}/CaimanVPN-windows-64.zip",
                    DownloadUrlWinArm64 = urlN + "/download/{0}/CaimanVPN-windows-arm64.zip",
                    DownloadUrlLinux64 = urlN + "/download/{0}/CaimanVPN-linux-64.zip",
                    DownloadUrlLinuxArm64 = urlN + "/download/{0}/CaimanVPN-linux-arm64.zip",
                    DownloadUrlOSX64 = urlN + "/download/{0}/CaimanVPN-macos-64.zip",
                    DownloadUrlOSXArm64 = urlN + "/download/{0}/CaimanVPN-macos-arm64.zip",
                },
