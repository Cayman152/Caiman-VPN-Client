...
using CaimanVPN.Desktop.Base;
using CaimanVPN.Desktop.Common;
using CaimanVPN.Desktop.Manager;
using CaimanVPN.Desktop.ViewModels;

namespace CaimanVPN.Desktop.Views;
...
public partial class MainWindow : WindowBase<MainWindowViewModel>
{
    ...
    {
        ProcUtils.ProcessStart("https://t.me/caiman_vpn_bot");
    }

    private void BtnGithub_Click(object? sender, RoutedEventArgs e)
    {
        ProcUtils.ProcessStart("https://github.com/Cayman152/Caiman-VPN-Client");
    }
    ...
    private void ApplyCaimanUiDefaults()
    {
