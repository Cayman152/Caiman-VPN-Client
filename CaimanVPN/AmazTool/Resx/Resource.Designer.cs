...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the CaimanVPN. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start CaimanVPN, please wait... 的本地化字符串。
        /// </summary>
        internal static string RestartCaimanVPN {
            get {
                return ResourceManager.GetString("RestartCaimanVPN", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the CaimanVPN process... 的本地化字符串。
        /// </summary>
